     ...
     <section class="container">
        ...
        <div class="row">
            <div class="main-content col-sm-12">
               <%-- <jsp:include page="/bootstrapTest/FormBootStrapJquery.jsp"></jsp:include> --%>
               <%-- <jsp:include page="/bootstrapTest/ResponsiveTableFormBootStrapJquery.jsp"></jsp:include> --%>
               <jsp:include page="/bootstrapTest/responsiveForm.jsp"></jsp:include> 
               <jsp:include page="/bootstrapTest/responsiveFormTwo.jsp"></jsp:include> 
            </div>
