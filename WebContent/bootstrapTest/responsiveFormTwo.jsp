...
<link href="<%= request.getContextPath() %>/bootstrap/css/datepicker.css" rel="stylesheet" />
...
<div class="container">
  <form class="form-horizontal" action=" " method="post"  id="reg_form">
    <fieldset>
     <legend>Legal Status/ Guardian</legend>
     <div class="form-group">
      <div class="col-sm-2"><p>First name</p><input class="form-control" type="text"></div>
      <div class="col-sm-2"><p>Last name</p><input class="form-control" type="text"></div>
      <div class="col-sm-2"><p>Middle name</p><input class="form-control" type="text"></div>
      <div class="col-sm-2">
      ...
      <div class="form-group">
	      ...
	      <div class="col-sm-2"><p>Appartment</p><input class="form-control" type="text"></div>
...
<!-- <script src="<%= request.getContextPath() %>/bootstrap/js/bootstrapvalidator.min.js"></script>  -->
 ...
 <script src="<%= request.getContextPath() %>/bootstrap/js/bootstrap-datepicker.js"></script>
